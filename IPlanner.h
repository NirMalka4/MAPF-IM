...
protected:
    ...
    static constexpr auto log_Maybe_Edeges_title = "#PotentialObstacles";
    static constexpr auto log_observation_prefix = "#observation";
    static constexpr auto log_Agent_prefix = "Agent";
    static constexpr auto log_observation_maybe_open = "maybe open";
    static constexpr auto log_observation_maybe_closed = "maybe closed";
    ...
    void LogMaybeEdges(const EdgeSet& maybe_edges);
};